...
const { handlemsg } = require(`${process.cwd()}/handlers/functions`);
    module.exports = {
  name: `loop`,
  description: `Repite la canción/cola actual`,
  parameters: {
    "type": "music",
    "activeplayer": true,
    "check_dj": true,
  ...
  options: [ 
    {"StringChoices": { name: "looptype", description: "Qué bucle quieres hacer??", required: true, choices: [["Bucle de canciones", "canción"], ["Bucle de cola", "cola"]] }},
  ],
