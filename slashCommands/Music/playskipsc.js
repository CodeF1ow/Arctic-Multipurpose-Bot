...
const { handlemsg } = require(`${process.cwd()}/handlers/functions`);
  ...
  description: `Reproduce una canción al instante desde soundcloud, es decir, salta la pista actual y reproduce la siguiente`,
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message, GuildSettings) => {
    ...
    try {
      ...
      interaction?.reply({content: `⏭️ Buscar e intentar reproducir: **${args[0]}** from \`Soundcloud\`!`})
