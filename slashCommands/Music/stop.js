        ...
        if (message.guild.me.voice.channel) {
          try {
            client.channels.cache.get(player.textChannel).messages.fetch(player.get("currentmsg")).then(msg => {
              ...
              .addComponents([
                new MessageButton().setCustomId('1').setEmoji("⏭").setLabel("Saltar").setStyle('SECONDARY').setDisabled(true),
                new MessageButton().setCustomId('2').setEmoji("⏹️").setLabel("Parar").setStyle('SECONDARY').setDisabled(true), 
                new MessageButton().setCustomId('3').setEmoji('⏸').setLabel("Pausar").setStyle('SECONDARY').setDisabled(true),
                new MessageButton().setCustomId('4').setEmoji('🔁').setLabel("Auto-play").setStyle('SECONDARY').setDisabled(true)
              ]);
              msg.edit({
      ...
      try {
        client.channels.cache.get(player.textChannel).messages.fetch(player.get("currentmsg")).then(msg => {
          ...
          .addComponents([
            new MessageButton().setCustomId('1').setEmoji("⏭").setLabel("Saltar").setStyle('SECONDARY').setDisabled(true),
            new MessageButton().setCustomId('2').setEmoji("⏹️").setLabel("Parar").setStyle('SECONDARY').setDisabled(true), 
            new MessageButton().setCustomId('3').setEmoji('⏸').setLabel("Pausa").setStyle('SECONDARY').setDisabled(true),
            new MessageButton().setCustomId('4').setEmoji('🔁').setLabel("Auto-play").setStyle('SECONDARY').setDisabled(true)
          ]);
          msg.edit({
            content: `Song has ended!`, 
