...
const { handlemsg } = require(`${process.cwd()}/handlers/functions`);
  ...
  category: `🎶 Music`,
  aliases: [`search`],
  description: `Busca una canción de youtube`,
  ...
  options: [ 
		{"String": { name: "what_song", description: "Qué canción/lista de reproducción desea buscar?? <LINK/SEARCH-QUERY>", required: true }}, 
	],
