...
module.exports = {
	name: "developer",
	description: "Muestra información sobre el promotor",
	run: async (client, interaction, cmduser, es, ls, prefix, player, message, GuildSettings) => {
		...
		try {	
			...
			let button_invite = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.developer.buttons.botlist).setURL(`https://arcticbot.xyz/invite`)
			const allbuttons = [new MessageActionRow().addComponents([button_public_invite, button_support_dc, button_invite])]
			const MessageButton = [new MessageActionRow().addComponents([button_public_invite, button_support_dc, button_invite])]
