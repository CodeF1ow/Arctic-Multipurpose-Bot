...
module.exports = {
  name: "emojiinfo",
  description: "Ver información sobre un emoji",
  options: [ 
		//{"Integer": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getInteger("ping_amount")
		{"String": { name: "emoji", description: "De qué Em oji quieres obtener detalles?", required: true }}, //to use in the code: interacton.getString("ping_amount")
