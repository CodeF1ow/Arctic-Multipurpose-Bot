...
module.exports = {
  ...
  options: [ 
    ...
    {"String": { name: "command", description: "Hay algún comando específico que desee detallar de?", required: false }}, //to use in the code: interacton.getString("ping_amount")
   
    //{"User": { name: "which_user", description: "De qué usuario quiere obtener the Avatar?", required: false }}, //to use in the code: interacton.getUser("ping_a_user")
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message, GuildSettings) => {
    ...
    if(!Category) return interaction?.reply({content: "Por favor, repita pero añada una CATEGORÍA", ephemeral: true})
