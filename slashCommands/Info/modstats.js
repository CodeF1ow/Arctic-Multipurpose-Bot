...
module.exports = {
  name: "modstats",
  description: "Muestra las estadísticas de administración de un Mod/Admin, cuántos cmds ha ejecutado etc.",
  options: [ 
		//{"Integer": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getInteger("ping_amount")
		//{"String": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getString("ping_amount")
		{"User": { name: "which_user", description: "De qué usuario quiere ver las estadísticas?", required: false }}, //to use in the code: interacton.getUser("ping_a_user")
