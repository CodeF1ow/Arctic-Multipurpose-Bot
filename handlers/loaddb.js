...
module.exports = client => {
    ...
    console.log(`${String("[x] :: ".magenta)}Cargando base de datos...`.brightGreen)
...
/*
    ...
    console.log(`[x] :: `.magenta + `CARGAR LAS BASES DE DATOS después de: `.brightGreen + `${Date.now() - dateNow}ms`.green)
}