                        ...
                        if (isAllowedUrl(arg, antisettings)) {
                            ...
                            if (!isOurInvite) {
                                ...
                                if(autowarn.antidiscord){
                                    client.userProfiles.ensure(message.author.id, {
                                        ...
                                        client.modActions.set(newActionId, {
                                            ...
                                            reason: "Aviso automático antidiscord",
                                        ...
                                        message.channel.send({
                                            embeds: [
                                                ...
                                                .setDescription(`> <@${message.author.id}> **recibió un aviso autogenerado - \`antidiscord\`**!\n\n> **Ahora tiene \`${warnings.length} Advertencias\`**`)
                                            ]
                                        });
                                ...
                                if (Number(countermap.get(message.author.id)) > mute_amount) {
                                    ...
                                    let reason = "Enviar demasiados enlaces de Discord en poco tiempo";
