...
module.exports = client => {
    ...
    function usr_antinuke_databasing(GUILDIDUSERID) {
        client.Anti_Nuke_System.ensure(GUILDIDUSERID, {
            ...
            antideleteuser: [], // ANTI EXPULSION & Ban
                    ...
                    try {
                        ...
                        if (ch) {
                            ch.send({embeds: [new MessageEmbed()
                                .setColor("YELLOW")
                                .setAuthor( 'Esto es un Warn',  'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/facebook/65/warning-sign_26a0.png')
                        ...
                        console.log("sistema anti Nuke - captador de errores".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                        return;
                    }
                }
                let AuditData = await member.guild.fetchAuditLogs({
                    ...
                    if (data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            return;
                        }
                    }
                    return;
                    ...
                    if (data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("YELLOW")
                                    .setAuthor( 'Esto es una advertencia',  'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/facebook/65/warning-sign_26a0.png')
                ...
                if (AddedMember) {
                    ...
                    try {
                        if (data.antibot.punishment.member.removeroles.enabled &&
                            ...
                            try {
                                if (!data.antibot.punishment.bot.ban && data.antibot.punishment.bot.kick) {
                                    ...
                                    if (data.all.logger && data.all.logger.length > 5) {
                                        try {
                                            ...
                                            if (ch) {
                                                ch.send({embeds: [new MessageEmbed()
                                                    .setColor("GREEN")
                                                    .setAuthor(`ANTI BOT - Ha sido expulsado: ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png")
                                    ...
                                    //kick the Bot
                                    member.kick(`Anti Bot - Añadido por: ${AddedUserID}`).catch((e) => {
                                        console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                                    });
                                }
                                if (data.antibot.punishment.bot.ban) {
                                    ...
                                    if (data.all.logger && data.all.logger.length > 5) {
                                        try {
                                            ...
                                            if (ch) {
                                                ch.send({embeds: [new MessageEmbed()
                                                    .setColor("GREEN")
                                                    .setAuthor(`Has sido banedo: ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png")
                                                    .setThumbnail(member.user.displayAvatarURL({
                                                        dynamic: true
                                                    }))
                                    ...
                                    //Ban the Bot
                                    member.ban({
                                        reason: `Anti Bot - Añadido por: ${AddedUserID}`
                                    }).catch((e) => {
                                        console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                                    });
                                }
                            ...
                            AddedMember.roles.set(roles2set).then(member => {
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("BLURPLE")
                                                .setAuthor(`ANTI ADD BOT - Eliminación de las funciones de ${AddedMember.user.tag} para añadir ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869664393783304212/869285770723217488.png")
                                                .setThumbnail(member.user.displayAvatarURL({
                                                    dynamic: true
                                                }))
                                ...
                                console.log(`Roles eliminados de ${member.user.tag} | ${member.user.id}`)
                            }).catch(() => {})
                        }
                        ...
                        if (AddedMember.kickable && data.antibot.punishment.member.kick.enabled &&
                            ...
                            //Kick the Member
                            AddedMember.kick(`Anti Bot - Él/ella agregó: ${member.user.id} | ${member.user.tag}`).then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        let ch = member.guild.channels.cache.get(data.all.logger);
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("ORANGE")
                                                .setAuthor(`ANTI ADD BOT - Expulsado ${AddedMember.user.tag} para añadir ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665099512688670/hammer_1f528.png")
                                ...
                                console.log(`ANTI Bot - Expulsado ${member.user.tag} | ${member.user.id}`)
                            }).catch((e) => {
                                console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            });
                        }
                        if (AddedMember.bannable && data.antibot.punishment.member.ban.enabled && ( //for 1 Day check
                            ...
                            //Ban the Member
                            AddedMember.ban({
                                    reason: `Anti Bot - Él agregó: ${AddedUserID} | ${member.user.tag}`
                                })
                                .then(member => {
                                    //If there is the logger enabled, send information
                                    if (data.all.logger && data.all.logger.length > 5) {
                                        try {
                                            ...
                                            if (ch) {
                                                ch.send({embeds: [new MessageEmbed()
                                                    .setColor("RED")
                                                    .setAuthor(`ANTI ADD BOT - Baneado ${AddedMember.user.tag} para añadir ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665114373095514/811556437284749322.png")
                                                    .setThumbnail(member.user.displayAvatarURL({
                                                        dynamic: true
                                                    }))
                                    ...
                                    console.log(`ANTI Bot - Baneado ${member.user.tag} | ${member.user.id}`)
                                })
                                .catch((e) => {
                                    console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                                });
    ...
    //anti EXPULSION - works | attemp counter fix...
            ...
            if (AddedMember) {
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI EXPULSION - ${AddedMember.user.tag}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI EXPULSION - ${AddedMember.user.tag} expulsado ${member.user.tag}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                ...
                try {
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI EXPULSION - Roles eliminados de ${AddedMember.user.tag} expulsar ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869664393783304212/869285770723217488.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                    ...
                    if (AddedMember.kickable && data.antideleteuser.punishment.member.kick.enabled &&
                        ...
                        //Kick the Member
                        AddedMember.kick(`Anti EXPULSIÓN - Él/ella expulso: ${member.user.id} | ${member.user.tag}`).then(member => {
                            //If there is the logger enabled, send information
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    let ch = member.guild.channels.cache.get(data.all.logger);
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI EXPULSION - Expulsado ${AddedMember.user.tag} expulsar ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665099512688670/hammer_1f528.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                            ...
                            console.log(`ANTI EXPULSION - Expulsado ${member.user.tag} | ${member.user.id}`)
                        }).catch((e) => {
                            console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                        });
                    }
                    if (AddedMember.bannable && data.antideleteuser.punishment.member.ban.enabled && ( //for 1 Day check
                        ...
                        //Ban the Member
                        AddedMember.ban({
                                reason: `Anti EXPULSIÓN - Él/Ella expulso: ${member.user.id} | ${member.user.tag}`
                            })
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI EXPULSION - Baneado ${AddedMember.user.tag} expulsar ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665114373095514/811556437284749322.png")
                                                .setThumbnail(member.user.displayAvatarURL({
                                                    dynamic: true
                                                }))
                                ...
                                console.log(`ANTI EXPULSION - Baneado ${member.user.tag} | ${member.user.id}`)
                            })
                            .catch((e) => {
                                console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            });
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI BAN - ${AddedMember.user.tag} expulsado ${member.user.tag}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                ...
                try {
                    if (data.antideleteuser.punishment.member.removeroles.enabled &&
                        ...
                        AddedMember.roles.set(roles2set).then(member => {
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI BAN - Roles eliminados de ${AddedMember.user.tag} fue baneado ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869664393783304212/869285770723217488.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                            ...
                            console.log(`ANTI BAN - Roles eliminados de ${member.user.tag} | ${member.user.id}`)
                        }).catch(() => {})
                    }
                    //Kick Member punishment 4
                    if (AddedMember.kickable && data.antideleteuser.punishment.member.kick.enabled &&
                        ...
                        //Kick the Member
                        AddedMember.kick(`Anti Ban - Él/Ella baneo: ${member.user.id} | ${member.user.tag}`).then(member => {
                            //If there is the logger enabled, send information
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    let ch = member.guild.channels.cache.get(data.all.logger);
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI BAN - Expulsado ${AddedMember.user.tag} fue baneado ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665099512688670/hammer_1f528.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                            ...
                            console.log(`ANTI Ban - Expulsado ${member.user.tag} | ${member.user.id}`)
                        }).catch((e) => {
                            console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                        });
                    }
                    if (AddedMember.bannable && data.antideleteuser.punishment.member.ban.enabled && ( //for 1 Day check
                        ...
                        //Ban the Member
                        AddedMember.ban({
                                reason: `Anti Ban - Él/Ella baneo: ${member.user.id} | ${member.user.tag}`
                            })
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI BAN - Baneado ${AddedMember.user.tag} fue baneado ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665114373095514/811556437284749322.png")
                                                .setThumbnail(member.user.displayAvatarURL({
                                                    dynamic: true
                                                }))
                                ...
                                console.log(`ANTI Ban - Baneado ${member.user.tag} | ${member.user.id}`)
                            })
                            .catch((e) => {
                                console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            });
    ...
    //ANTI CREAR CANALES - works | attemp counter fix...
    client.on("channelCreate", async (channel) => {
        try {
            if (!channel.guild) return;
            simple_databasing(client, channel.guild.id)
            ...
            if (AddedMember) {
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI CREAR CANALES - ${AddedMember.user.tag}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI CREAR CANALES - ${AddedMember.user.tag} creado ${channel.name}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                ...
                try {
                    if (data.antichannelcreate.punishment.member.removeroles.enabled &&
                        ...
                        try {
                            if (data.antichannelcreate.punishment.deletecreatedchannel) {
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("GREEN")
                                                .setAuthor(`ANTI CHANNEL-CREATE - Eliminado: ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png")
                                ...
                                //kick the Bot
                                channel.delete(`ANTI CREAR CANALES - Creado por: ${AddedUserID}`).catch((e) => {
                                    console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                                });
                            }
                        } catch (e) {
                        ...
                        AddedMember.roles.set(roles2set).then(member => {
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI CREAR CANALES - Roles eliminados de ${AddedMember.user.tag} fue creado ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869664393783304212/869285770723217488.png")
                            ...
                            console.log(`ANTI CREAR CANALES - Roles eliminados de ${member.user.tag} | ${member.user.id}`)
                        }).catch(() => {})
                    }
                    //Kick Member punishment 4
                    if (AddedMember.kickable && data.antichannelcreate.punishment.member.kick.enabled &&
                        ...
                        //Kick the Member
                        AddedMember.kick(`ANTI CREAR CANALES - Creado: ${channel.id} | ${channel.name}`).then(member => {
                            //If there is the logger enabled, send information
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    let ch = channel.guild.channels.cache.get(data.all.logger);
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI CREAR CANALES - Expulsado ${AddedMember.user.tag} creado ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665099512688670/hammer_1f528.png")
                            ...
                            console.log(`ANTI CREAR CANALES - Expulsado ${member.user.tag} | ${member.user.id}`)
                        }).catch((e) => {
                            console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                        });
                    }
                    if (AddedMember.bannable && data.antichannelcreate.punishment.member.ban.enabled && ( //for 1 Day check
                        ...
                        //Ban the Member
                        AddedMember.ban({
                                reason: `ANTI CREAR CANALES - Creado: ${channel.id} | ${channel.name}`
                            })
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI CREAR CANALES - Baneado ${AddedMember.user.tag} para crear ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665114373095514/811556437284749322.png")
                                ...
                                console.log(`ANTI CREAR CANALES - Banned ${member.user.tag} | ${member.user.id}`)
                            })
                            .catch((e) => {
                                console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            });
    ...
    client.on("channelDelete", async (channel) => {
        try {
            ...
            let ls = client.settings.get(channel.guild.id, "language")
            const eventsTimestamp = Date.now().toString()
            if (!channel.guild) return console.log("NO PUDO ENCONTRAR EL SERVIDOR");
            antinuke_databasing(channel.guild.id);
            let data = client.Anti_Nuke_System.get(channel.guild.id)
            ...
            const eventtime = EventExecution.slice(0, -3);
            if (logtime !== eventtime) return   
            if (AddedUserID == client.user.id) return console.log("SOY EL BORRADOR - NO ANTI");
            let AddedMember = await channel.guild.members.fetch(AddedUserID).catch((e) => {
                if (data.all.logger && data.all.logger.length > 5) {
                    try {
                        let ch = channel.guild.channels.cache.get(data.all.logger);
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`BORRADO DE CANALES - ${AddedMember.user.tag}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`BORRADO DE CANALES - ${AddedMember.user.tag} eliminar ${channel.name}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                ...
                try {
                    if (data.antichanneldelete.punishment.member.removeroles.enabled &&
                        ...
                        AddedMember.roles.set(roles2set).then(member => {
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`BORRADO DE CANALES - Roles eliminados de ${AddedMember.user.tag} para borrar ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869664393783304212/869285770723217488.png")
                            ...
                            console.log(`BORRADO DE CANALES - Roles eliminados de ${member.user.tag} | ${member.user.id}`)
                        }).catch(() => {})
                    }
                    //Kick Member punishment 4
                    if (AddedMember.kickable && data.antichanneldelete.punishment.member.kick.enabled &&
                        ...
                        //Kick the Member
                        AddedMember.kick(`BORRADO DE CANALES - Creado: ${channel.id} | ${channel.name}`).then(member => {
                            //If there is the logger enabled, send information
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    let ch = channel.guild.channels.cache.get(data.all.logger);
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`BORRADO DE CANALES - Kicked ${AddedMember.user.tag} para borrar ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665099512688670/hammer_1f528.png")
                            ...
                            console.log(`ANTI BORRADO DE ROLES - Kicked ${member.user.tag} | ${member.user.id}`)
                        }).catch((e) => {
                            console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                        });
                    }
                    if (AddedMember.bannable && data.antichanneldelete.punishment.member.ban.enabled && ( //for 1 Day check
                        ...
                        //Ban the Member
                        AddedMember.ban({
                                reason: `BORRADO DE CANALES - He deleting: ${channel.id} | ${channel.name}`
                            })
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`BORRADO DE CANALES - Banned ${AddedMember.user.tag} para borrar ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665114373095514/811556437284749322.png")
                                ...
                                console.log(`BORRADO DE CANALES - Baneado ${member.user.tag} | ${member.user.id}`)
                            })
                            .catch((e) => {
                                console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            });
    ...
    //ANTI CREACIÓN DE ROLES - works | attemp counter fix...
            ...
            if (AddedMember) {
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI CREACIÓN DE ROLES - ${AddedMember.user.tag}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI CREACIÓN DE ROLES - ${AddedMember.user.tag} creado ${role.name}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                ...
                try {
                    if (data.anticreaterole.punishment.member.removeroles.enabled &&
                        ...
                        try {
                            if (data.anticreaterole.punishment.removeaddedrole) {
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("GREEN")
                                                .setAuthor(`ANTI CREACIÓN DE ROLES - Borrado: ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png")
                                ...
                                //kick the Bot
                                role.delete(`Anti ROLECREATE - Creado por: ${AddedUserID}`).catch((e) => {
                                    console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                                });
                            }
                        } catch (e) {
                        ...
                        AddedMember.roles.set(roles2set).then(member => {
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI CREACIÓN DE ROLES - Roles eliminados de ${AddedMember.user.tag} para crear ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869664393783304212/869285770723217488.png")
                            ...
                            console.log(`ANTI CREACIÓN DE ROLES - Roles eliminados de ${member.user.tag} | ${member.user.id}`)
                        }).catch(() => {})
                    }
                    //Kick Member punishment 4
                    if (AddedMember.kickable && data.anticreaterole.punishment.member.kick.enabled &&
                        ...
                        //Kick the Member
                        AddedMember.kick(`ANTI CREACIÓN DE ROLES - He/SCreado: ${role.id} | ${role.name}`).then(member => {
                            //If there is the logger enabled, send information
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    let ch = role.guild.channels.cache.get(data.all.logger);
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI CREACIÓN DE ROLES - Expulsado ${AddedMember.user.tag} para crear ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665099512688670/hammer_1f528.png")
                            ...
                            console.log(`ANTI CREACIÓN DE ROLES - Expulsado ${member.user.tag} | ${member.user.id}`)
                        }).catch((e) => {
                            console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                        });
                    }
                    if (AddedMember.bannable && data.anticreaterole.punishment.member.ban.enabled && ( //for 1 Day check
                        ...
                        //Ban the Member
                        AddedMember.ban({
                                reason: `ANTI CREACIÓN DE ROLES - Creado: ${role.id} | ${role.name}`
                            })
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI CREACIÓN DE ROLES - Baneado ${AddedMember.user.tag} para crear ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665114373095514/811556437284749322.png")
                                ...
                                console.log(`ANTI CREACIÓN DE ROLES - Baneado ${member.user.tag} | ${member.user.id}`)
                            })
                            .catch((e) => {
                                console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            });
    ...
    //ANTI BORRADO DE ROLES - works | attemp counter fix...
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI BORRADO DE ROLES - ${AddedMember.user.tag}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                    ...
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            ...
                            if (ch) {
                                ch.send({embeds: [new MessageEmbed()
                                    .setColor("#fffff9")
                                    .setAuthor(`ANTI BORRADO DE ROLES - ${AddedMember.user.tag} eliminado ${role.name}`, AddedMember.user.displayAvatarURL({
                                        dynamic: true
                                    }))
                ...
                try {
                    if (data.antideleterole.punishment.member.removeroles.enabled &&
                        ...
                        AddedMember.roles.set(roles2set).then(member => {
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI BORRADO DE ROLES - Roles eliminados de ${AddedMember.user.tag} para borrar ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869664393783304212/869285770723217488.png")
                            ...
                            console.log(`ANTI BORRADO DE ROLES - Roles eliminados de ${member.user.tag} | ${member.user.id}`)
                        }).catch(() => {})
                    }
                    //Kick Member punishment 4
                    if (AddedMember.kickable && data.antideleterole.punishment.member.kick.enabled &&
                        ...
                        //Kick the Member
                        AddedMember.kick(`ANTI BORRADO DE ROLES - Creado: ${role.id} | ${role.name}`).then(member => {
                            //If there is the logger enabled, send information
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    let ch = role.guild.channels.cache.get(data.all.logger);
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI BORRADO DE ROLES - Expulsado ${AddedMember.user.tag} para borrar ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665099512688670/hammer_1f528.png")
                            ...
                            console.log(`ANTI BORRADO DE ROLES - Expulsado ${member.user.tag} | ${member.user.id}`)
                        }).catch((e) => {
                            console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                        });
                    }
                    if (AddedMember.bannable && data.antideleterole.punishment.member.ban.enabled && ( //for 1 Day check
                        ...
                        //Ban the Member
                        AddedMember.ban({
                                reason: `ANTI BORRADO DE ROLES - Creado: ${role.id} | ${role.name}`
                            })
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI BORRADO DE ROLES - Baneado ${AddedMember.user.tag} para borrar ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/869665114373095514/811556437284749322.png")
                                ...
                                console.log(`ANTI BORRADO DE ROLES - Baneado ${member.user.tag} | ${member.user.id}`)
                            })
                            .catch((e) => {
                                console.log("sistema anti Nuke - error-catcher".dim.cyan, e.stack ? String(e.stack).grey.grey : String(e).grey.grey)
                            });
