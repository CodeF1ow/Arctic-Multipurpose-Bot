  ...
  client.on("guildMemberUpdate", async (oM, nM) => {
    ...
    client.settings.ensure(nM.guild.id, {
      boost: {
        ...
        message: "",
        log: false,
        stopBoost: "<a:Server_Boosts:1021619533947093002> {member} **stopped Boosting us..** <:Cat_Sad:1021621045247094795>",
        startBoost: "<a:Server_Boosts:1021619533947093002> {member} **has boosted us!** <a:Light_Saber_Dancce:1021620724965842977>",
        againBoost: "<a:Server_Boosts:1021619533947093002> {member} **has boosted us again!** <a:Tada_WON:1021569975963627520>",
      }
    })
