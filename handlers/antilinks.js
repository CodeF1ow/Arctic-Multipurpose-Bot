                        ...
                        if (isValidURL(arg) && isAllowedUrl(arg, antisettings)) {
                            ...
                            if (message.content.includes("```")) {
                                try {
                                    ...
                                    message.author.send(`Parece que has enviado un código en ${message.channel} **${message.guild.name}**, pero contiene un enlace, que no está permitido!`).catch((e) => {
                                        console.log(String(e))
                                    })
                                } catch (e) {
                                    console.log(String(e))
                            ...
                            if(autowarn.antilinks){
                                client.userProfiles.ensure(message.author.id, {
                                    ...
                                    client.modActions.set(newActionId, {
                                        ...
                                        reason: "Aviso automático Antilinks",
                                    ...
                                    message.channel.send({
                                        embeds: [
                                            ...
                                            .setDescription(`> <@${message.author.id}> **recibió un aviso autogenerado - \`antilinks\`**!\n\n> **Ahora tiene \`${warnings.length} Advertencias\`**`)
                                        ]
                                    });
                            ...
                            if (Number(countermap.get(message.author.id)) > mute_amount) {
                                ...
                                let reason = "Enviar demasiados enlaces en poco tiempo";
