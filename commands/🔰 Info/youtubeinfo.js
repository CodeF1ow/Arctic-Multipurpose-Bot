...
module.exports = {
  ...
  category: "🔰 Info",
  description: "Obtenga información sobre un canal de Youtube Link-Canal",
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed().setColor(es.color)
        .setAuthor(client.la[ls].cmds.info.youtubeinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://arcticbot.xyz/discord")]})
