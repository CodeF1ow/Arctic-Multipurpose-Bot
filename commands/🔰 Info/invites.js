  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      message.reply({embeds: [new Discord.MessageEmbed()
        .setAuthor(handlemsg(client.la[ls].cmds.info.invites.author, {usertag: user.tag}), user.displayAvatarURL({dynamic: true}), "https://arcticbot.xyz/discord")
