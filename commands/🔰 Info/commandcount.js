...
module.exports = {
  ...
  aliases: ["cmdcount"],
  usage: "commandcount",
  description: "Muestra la cantidad de comandos",
  type: "bot",
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let tempmsg = await message.reply({embeds: [new MessageEmbed()
        .setColor(es.color)
        .setFooter("Puede tardar hasta 30 segundos ...", client.user.displayAvatarURL())
        .setAuthor(handlemsg(client.la[ls].cmds.info.commandcount.tempmsg), "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://arcticbot.xyz/discord")
      ]})
      let lines = 0
      let letters = 0
