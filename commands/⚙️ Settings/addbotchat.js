...
module.exports = {
    ...
    category: `⚙️ Ajustes`,
    description: `Permite habilitar un chat sólo para bots en el que la comunidad puede utilizar comandos`,
    ...
    try{
      ...
      let leftb = ``;
      if(client.settings.get(message.guild.id, `botchannel`).join(``) ===``) leftb = `no hay Canales, es decir, todos los Canales son Canales Bot`
      else
