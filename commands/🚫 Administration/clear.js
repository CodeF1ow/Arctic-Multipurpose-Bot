...
module.exports = {
  ...
  description: `Elimina los mensajes de un canal de texto o un número determinado de mensajes de un canal de texto.\n\nSi haces ping a un usuario / escribes "BOTS" después de él, la cantidad de mensajes que das, es la cantidad de mensajes que se comprobarán, no que se borrarán!`,
    ...
    try {
      ...
      if(args[1]){
        if(args[1].toLowerCase() == "bots" || args[1].toLowerCase() == "bot"){
          ...
          let msgs = messageCollection.map(this_Code_is_by_Kiri86_8565 => this_Code_is_by_Kiri86_8565)
