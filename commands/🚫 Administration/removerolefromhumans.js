   ...
   run: async (client, message, args, cmduser, text, prefix) => {
     ...
     try {
      ...
      return message.reply({embeds : [new MessageEmbed()
       ...
       var members = message.guild.members.cache.filter(member => !member.user.bot && member.roles.cache.has(role.id)).map(this_Code_is_by_Kiri86_8565 => this_Code_is_by_Kiri86_8565);
