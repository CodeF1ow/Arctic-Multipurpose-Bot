 ...
 module.exports = {
   ...
   description: `Añade un rol a cada BOT de este servidor`,
   type: "memberrole",
       ...
       function send_finished() {
         ...
         message.reply({
           ...
           embeds: [new MessageEmbed()
             ...
             .setDescription(`Añadido con éxito ${role} a \`${success} BOTS\` de \`${counter} BOTS\`${failed != 0 ? `\n${failed} Miembros, no consiguieron el añadido, rehacerlo con: \`${prefix}addroletobots ${role.id}\``: ""}`)
          ]});
       }
