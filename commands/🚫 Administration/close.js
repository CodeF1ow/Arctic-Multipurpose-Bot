...
module.exports = {
  ...
  cooldown: 2,
  usage: "ticket",
  description: "Gestiona el ticket, lo cierra, lo borra, crea un registro, etc..",
  type: "channel",
...
> 📑 **== Crear un registro** de la entrada

> 👤 **==** Gestionar el acceso de los **Usuarios** (Añadir/Eliminar)

> 📌 **==** Gestionar el acceso a las funciones (añadir/eliminar)`).setFooter(client.getFooter(es))
