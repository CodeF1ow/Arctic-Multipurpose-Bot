    ...
    try {
      ...
      try {
        ...
        client.modActions.set(newActionId, {
          ...
          oldhighesrole: warnmember.roles ? warnmember.roles.highest : `No tenia ningun Rol`,
        ...
        message.reply({embeds :[new MessageEmbed()
          ...
          .setDescription(`**Ahora tiene: ${warnings.length} Warnings in ${message.guild.name}**`.substring(0, 2048))
        ]});
