...
module.exports = {
  ...
  aliases: ["imageembed"],
  cooldown: 2,
  usage: "imgembed <TITLE> ++ <IMAGEURL> ++ <DESCRIPTION>\n\n Para tener, por ejemplo, ningún título hacer que:  imgembed ++ https://i.imgur.com/sohWhy9.jpg ++ Este es el aspecto de un Embed sin imagen",
  description: "Reenvía un mensaje de u como un Embed con la opción de tener una IMAGEN",
  type: "server",
