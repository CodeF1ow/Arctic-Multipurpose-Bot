...
module.exports = {
  ...
  description: `Muestra los avisos de un usuario, de forma global`,
      ...
      try {
        ...
        for (let i = 0; i < warnings.length; i++) {
          string +=
            `================================
**Advertir Id:** \`${i}\`
**Advertido en:** \`${warnings[i].when}\`
**Advertido en:** \`${client.guilds.cache.get(warnings[i].guild) ? client.guilds.cache.get(warnings[i].guild).name :  warnings[i].guild}\`
**Razón:** \`${warnings[i].reason.length > 50 ? warnings[i].reason.substring(0, 50) + ` ...` : warnings[i].reason}\`
`
        }
