...
module.exports = {
  ...
  cooldown: 5,
  usage: "setup-antinuke --> Siga los pasos",
  description: "Gestionar el sistema anti-nuke",
    ...
    try {
      ...
      async function first_layer(){
        let menuoptions = [
          {
            value: "Information",
            description: `Como se informa sobre el sistema Anti Nuke`,
            emoji: "869468766529003560"
          },
          {
            value: "Gestionar la lista blanca",
            description: `Permitir/Denegar Roles/Usuarios que no deben ser afectados`,
            emoji: "857334024087011378"
          },
          {
            value: "Gestionar la configuración",
            description: `Activar/Desactivar y cambiar la configuración de Anti Nuke`,
            emoji: "866089513654419466"
          },
          {
            value: "Ajustes sugeridos",
            description: `Utilice nuestros ajustes sugeridos!`,
            emoji: "866089515993792522"
          },
          {
            value: "Función de cuarentena de sincronización",
            description: `Añade el Permiso __VIEW_CH__. a todos los Chans.para el Qu. Rol`,
            emoji: "🔒"
          },
          
          {
            value: "Cancel",
            description: `Cancelar y detener el Anti Nuke Setup!`,
        ...
        let Selection = new MessageSelectMenu()
          ...
          .setPlaceholder('Haga clic en mí para configurar el sistema Anti Nuke!') 
          .addOptions(
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://arcticbot.xyz/discord')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "​✔️ **La configuración actual de Anti Nuke**", embeds: [new MessageEmbed()
              .setColor(es.color)
            ...
            .addField("**Otros sistemas de seguridad:**", `\`${prefix}setup-antidiscord\` *... Activar/desactivar y ajustar los enlaces de invitación a la discord*\n\`${prefix}setup-antilink\` *... Activar/desactivar y ajustar los antienlaces*\n\`${prefix}setup-anticaps\` *... Activar/desactivar y ajustar el anti-spamming de Caps*\n\`${prefix}setup-blacklist\` *... para añadir/eliminar Palabras Malas (negras)*`)]
          });
          } 
          else if(menu?.values[0] == "Gestionar la lista blanca"){
            menu?.deferUpdate();
            menuoptions = [
              {
                value: "Usuarios generales/Roles",
                description: `Añadir/Eliminar Usuarios/Roles generales`,
                emoji: "866089515993792522"
              },
              {
                value: "Anti Bot Añadir Usuarios/Roles",
                description: `Añadir/Quitar Anti-Bot-Añadir Usuarios/Roles`,
                emoji: "843943149902626846"
              },
              {
                value: "Anti Expulsión/Prohibición de Usuarios/Roles",
                description: `Añadir/eliminar usuarios/roles antiexpulsivos`,
                emoji: "843943149868023808"
              },
              {
                value: "Anti Crear Rol Usuarios/Roles",
                description: `Añadir/Eliminar Usuarios/Roles Anti-Creación`,
                emoji: "843943149914554388"
              },
              {
                value: "Anti Borrar Rol Usuarios/Roles",
                description: `Añadir/eliminar usuarios/roles de Anti-Delete-Role`,
                emoji: "843943149919535154"
              },
              {
                value: "Anti Crear Usuarios/Roles del Canal",
                description: `Añadir/eliminar usuarios/roles de los canales anti-créditos`,
                emoji: "843943149759889439"
              },
              {
                value: "Anti Supresión de Usuarios/Roles del Canal",
                description: `Añadir/eliminar usuarios/roles del canal antiborrado`,
            ...
            let Selection = new MessageSelectMenu()
              ...
              .setMaxValues(1) //OPTIONAL, this is how many values you can have at each selection
              .setMinValues(1) //OPTIONAL , this is how many values you need to have at each selection
              .setPlaceholder('Haga clic en mí para configurar los ajustes de Anti Nuke!') 
              .addOptions(
                menuoptions.map(option => {
                  let Obj = {
                    label: option.label ? option.label.substring(0, 50) : option.value.substring(0, 50),
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Ajustes Anti Nuke', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://arcticbot.xyz/discord')
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`**Se ha eliminado [${removedroles.length}] Roles and [${removedusers.length}] Users from the __general__ Whitelist!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`🚪 **Se ha retirado \`[${removedroles.length}] Roles\` y \`[${removedusers.length}] Usuarios de la __Anti Bot add__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`🚪 **Eliminado \`[${removedroles.length}] Roles\` y \`[${removedusers.length}] Usuarios\` de la __Anti Crear Kick/Ban__ Whitelist(modulo)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`🚪 **Eliminado \`[${removedroles.length}] Roles\` y \`[${removedusers.length}] Usuarios\` de la __Anti Crear Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`🚪 **Retirada \`[${removedroles.length}] Roles\` y \`[${removedusers.length}] Usuarios\` de la __Anti Borrar Role__ Whitelist (modulo)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`🚪 **Retirada \`[${removedroles.length}] Roles\` y \`[${removedusers.length}] Usuarios del __Anti Channel Create__ Whitelist (modulo)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`🚪 **Retirada \`[${removedroles.length}] Roles\` y \`[${removedusers.length}] Usuarios de la __Anti canal Delete__ Whitelist (modulo)!**`.substring(0, 2048))
          ...
          else if(menu?.values[0] == "Gestionar la configuración"){
              menu?.deferUpdate();
              menuoptions = [
                {
                  value: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "Deshabilitar el AntiNuke completo": "Activar el Anti Nuke completo",
                  description: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "No voy a trabajar más": "Estaré habilitado",
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "833101993668771842": "833101995723194437"
                },
                {
                  value: "Establecer registrador",
                  description: `Define a (new) Logger Channel`,
                  emoji: "866089515993792522"
                },
                {
                  value: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "Deshabilitar el registro de la whitelist": "Activar el registro de la whitelist",
                  description: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "No mostraré cuando un usuario de la lista blanca haga smt": "Voy a mostrar cuando un usuario de la lista blanca hace smt (no voy a hacer smt tho)",
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "833101993668771842": "833101995723194437"
                },
                {
                  value: "Modificar la función de cuarentena",
                  description: "Eliminar/añadir el rol de Qurantine",
                  emoji: "865686493016096809"
                },
                {
                  value: "Anti Bot Add",
                  description: `Ajustar la configuración del sistema Anti Bot Add`,
                  emoji: "843943149902626846"
                },
                {
                  value: "Anti Kick/Ban",
                  description: `Ajustar la configuración del sistema antiexpulsión/prohibición`,
                  emoji: "843943149868023808"
                },
                {
                  value: "Función anti creación rol",
                  description: `Ajustar la configuración del Anti Crear Role System`,
                  emoji: "843943149914554388"
                },
                {
                  value: "Anti Delete Role",
                  description: `Ajustar la configuración del Anti Borrado Role System`,
                  emoji: "843943149919535154"
                },
                {
                  value: "Anti Create Channel",
                  description: `Ajustar la configuración del Anti Crear Channel System`,
                  emoji: "843943149759889439"
                },
                {
                  value: "Anti Delete Channel",
                  description: `Ajustar la configuración del Anti Borrado Channel System`,
                  emoji: "843943150468857876"
                },
                {
                  value: "Cancel",
              ...
              async function menuselection3(menu) {
                ...
                if(String(index) == "0"){
                      ...
                      if(message.mentions.channels.filter(ch=>ch.guild.id==message.guild.id).first()){
                        try{
                          message.mentions.channels.filter(ch=>ch.guild.id==message.guild.id).first().send({embeds: [new Discord.MessageEmbed()
                            ...
                            .setColor(es.color)
                            .setDescription(`**Aquí hay algunas informaciones:**\n>>> En el **FOOTER** (abajo), serán las informaciones (ID y AVATAR) del EJECUTOR\nEn el **AUTOR** (arriba), habrá información sobre el **MÉTODO**\n\nSi hay una **Miniatura**, será la **Información de destino**\n\nCada Embed, que es **VERDE**, es una acción de seguridad de **ME**\nCada incrustación en **Amarillo** es una **Alerta**.\nCada incrustación en **NARANJA** es una **EXPULSION**.\nCada Embed en **Red** es un **Ban**\nCada incrustación en **BLURPLE** es un **Remove Role**`.substring(0, 2048))
                            .setFooter(client.getFooter(es))]
                          })
                        }catch (e){
                        ...
                        try{
                          message.reply({embeds: [new Discord.MessageEmbed()
                            ...
                            .setColor(es.color)
                            .setDescription(`**Aquí hay algunas informaciones:**\n>>> En el **FOOTER** (abajo), será Información (ID y AVATAR) del EJECUTOR\nEn el **AUTOR** (arriba), habrá información sobre el **MÉTODO**.\n\nSi hay una **Miniatura**, será la **Información de destino**\n\nCada Embed, que es **VERDE**, es una acción de seguridad de **ME**\nCada incrustación en **Amarillo** es una **Alerta**.\nCada incrustación en **NARANJA** es una **EXPULSION**.\nEvery Embed in **RED** is a **BAN**\nCada incrustación en **BLURPLE** es un **Remove Role**.`.substring(0, 2048))
                            .setFooter(client.getFooter(es))
                          ]})
                        }catch (e){
                          console.log(e.stack ? String(e.stack).grey : String(e).grey)
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          ...
                          .setColor(es.color)
                          .setDescription(`Si es necesario ejecutar algunas acciones Anti Nuke, las registraré allí!`.substring(0, 2048))
                          .setFooter(client.getFooter(es))]
                        });
                      }
                      else{
                        throw "NO HAY NINGÚN CANAL QUE HAYA SIDO PINGADO";
                      }
                    })
                    .catch(e => {
                      timeouterror = e;
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                    ...
                    .then(async collected => {
                      var message = collected.first();
                      if(!message || !message.content) throw "NO SE HA ENVIADO NINGÚN MENSAJE";
                      ...
                      if(message.mentions.roles.filter(r=>r.guild.id==message.guild.id).first()){
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          ...
                          .setColor(es.color)
                          .setDescription(`Este rol se añadirá, si el usuario consigue eliminar los roles!\n> También puede ejecutar un comando en el \`${prefix}setup-antinuke\` to set all channels to not visible when having this Role!`.substring(0, 2048))
                          .setFooter(client.getFooter(es))]
                        });
                      }
                      else{
                  ...
                  let thenames = {
                    "antibot" : "Anti Agregar bot",
                    "antideleteuser": "Anti Kick/Ban",
                    "anticreaterole": "Anti Crear Rol",
                    "antideleterole": "Anti Eliminar Rol",
                    "antichannelcreate": "Anti Crear Canal",
                    "antichanneldelete": "Anti Eliminar Canal",
                  }
                   ...
                   */
                    ...
                    async function first_layer(){
                      menuoptions = [
                        {
                          value: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? `Deshabilitado ${thename}`: `Habilitar ${thename}`,
                          description: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? `${thename} dejará de funcionar`: `${thename} Estara en funcionamiento`,
                          emoji: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "833101993668771842": "833101995723194437"
                        },
                        {
                          value: "Eliminar Roles / Días",
                          description: `Cantidad de Acciones / Día para eliminar los Roles`,
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(es.color)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://arcticbot.xyz/discord')
          ...
          else if(menu?.values[0] == "Ajustes sugeridos"){
            ...
            return menu?.reply({content: "​✔️ **Usando los ajustes sugeridos!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
          ...
          else if(menu?.values[0] == "Función de cuarentena de sincronización"){
            ...
            for(const ch of channels.map(este_código_es_por_Kiri86_8565 => este_código_es_por_Kiri86_8565)){
              try {
                if(ch) {
