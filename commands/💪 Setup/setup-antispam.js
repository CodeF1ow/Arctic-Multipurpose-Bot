...
module.exports = {
  ...
  description: "Habilitar + Cambiar la cantidad máxima de mensajes que se pueden enviar en menos de 10 segundos",
...
///////////////////////////////////////
      ...
      async function first_layer(){
        let menuoptions = [
          {
            value: `Habilitar y configurar el antispam`,
            description: "Habilitar y limitar los mensajes permitidos / 10 segundos",
            emoji: "833101995723194437"
          },
          {
            value: `Deshabilitar Anti Spam`,
            description: "No impida el Spamming",
            emoji: "833101993668771842"
          },
          {
            value: "Settings",
            description: `Mostrar la configuración actual del sistema antispam`,
            emoji: "📑"
          },
          {
          ...
          {
            value: "Cancel",
            description: `Cancelar y detener la configuración del Anti-Spam!`,
            emoji: "862306766338523166"
          }
        ]
        let Selection = new MessageSelectMenu()
          .setPlaceholder('Haga clic en mí para configurar el sistema antispam!').setCustomId('MenuSelection') 
