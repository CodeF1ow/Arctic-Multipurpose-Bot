...
module.exports = {
    ...
    cooldown: 10,
    usage: "setup-radio <RadioStation Num.>   -->    al estar en una emisora de radio",
    description: "Gestionar el sistema de sala de espera / sistema de radio 24/7",
      ...
      try{
        ...
        //if not found send an error
          ...
          return message.channel.send({embeds: [new MessageEmbed()
            .setColor(es.wrongcolor)
            .setTitle(`${emoji.msg.ERROR} Error | Estación de radio no encontrada`)
            .setDescription(`Por favor, utilice una estación entre \`1\` y \`${lengthUntil(radios.OTHERS.request)}\``)
          ]});
        ...
        //send the message of the searching <a<:bot:1015894300153888878>859459305152708630> <a:Disco:1015905502795927572> 
        message.reply(
            new Discord.MessageEmbed()
                .setTitle("<a:Disco:1015905502795927572> Configuración completa de la emisora de radio:  " + song.title)
                .setColor("#7fafe3")
