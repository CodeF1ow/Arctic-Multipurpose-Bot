...
module.exports = {
	...
	usage: "httpstatus <status>", //this is for the help command for EACH cmd
  	description: "Mostrar httpstatus con un meme.", //the description of the command
  	...
  	run: async (client, message, args, cmduser, text, prefix) => {
		...
		try {
			...
			return message.reply({embeds: [new MessageEmbed()
			  ...
			  .setDescription(status === "599" ? "Error de tiempo de espera de conexión a la red" : STATUS_CODES[status])
