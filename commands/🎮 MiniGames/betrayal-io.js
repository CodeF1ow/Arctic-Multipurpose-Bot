const {
  ...
  module.exports = {
    ...
    category: "🎮 Minijuegos",
    type: "voice",
    description: "Genera un enlace de betrayal.io para jugar una partida de traición con tus amigos (a través de discord)",
    usage: "betrayal-io --> Haga clic en el enlace | TIENE QUE ESTAR EN UN CANAL DE VOZ!",
    /*
