const {
  ...
  module.exports = {
    ...
    category: "🎮 Minijuegos",
    type: "voice",
    description: "Genera un enlace de chess.io para jugar una partida de ajedrez con tus amigos (a través de discord)",
    usage: "chess --> Haga clic en el enlace | TIENE QUE ESTAR EN UN CANAL DE VOZ!",
    /*
