const {
  ...
  module.exports = {
    ...
    category: "🎮 Minijuegos",
    type: "voice",
    description: "Genera un enlace de fishington.io para jugar una partida de pesca con tus amigos (a través de Discord).",
    usage: "fishington-io --> Haga clic en el enlace | TIENE QUE ESTAR EN UN CANAL DE VOZ!",
    /*
