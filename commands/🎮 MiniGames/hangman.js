...
class HangmanGame {
    ...
    newGame(msg) {
        ...
        const embed = new Discord.MessageEmbed()
            .setColor("#2f3136")
            .setAuthor('Hangman Minigame', "https://imgur.com/0guxxtY.png", "https://arcticbot.xyz/discord")
            .setDescription(this.getDescription())
            .addField(eval(client.la[ls]["cmds"]["minigames"]["hangman"]["variablex_1"]), eval(client.la[ls]["cmds"]["minigames"]["hangman"]["variable1"]))
            .addField('Cómo jugar', "Reacciona a este mensaje utilizando los emojis que parecen letras (🅰️, 🇹, )")
    ...
    makeGuess(reaction) {
        ...
        if (this.inGame) {
            const editEmbed = new Discord.MessageEmbed()
                ...
                .setDescription(this.getDescription())
                .addField('Letras adivinadas', this.guesssed.length == 0 ? '\u200b' : this.guesssed.join(" "))
                .addField('Cómo jugar', "Reacciona a este mensaje utilizando los emojis que parecen letras (🅰️, 🇹, )")
    ...
    gameOver(win) {
        ...
        const editEmbed = new Discord.MessageEmbed()
            .setColor('RED')
            .setAuthor('Hangman Minijuego', "https://imgur.com/0guxxtY.png", "https://arcticbot.xyz/discord")
            .setDescription((win ? "**Gana el chat!**" : "**Pierde el Chat**"))
...
module.exports = {
    ...
    aliases: ["hm"],
    category: "🎮 Minijuegos",
    description: "Permite jugar al ahorcado",
    usage: "hangman --> Juega el juego",
    type: "text",
