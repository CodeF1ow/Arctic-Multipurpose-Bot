const {
  ...
  module.exports = {
    ...
    category: "🎮 Minijuegos",
    type: "voice",
    description: "Genera un enlace de noche de póker para jugar al póker con tus amigos. (a través de discordia)",
    usage: "poker-night --> Haga clic en el enlace | TIENE QUE ESTAR EN UN CANAL DE VOZ!",
    /*
...
814288819477020702 Fishington.io
    */
     run: async (client, message, args, cmduser, text, prefix) => {
      return message.reply("Este comando no se admite actualmente!");
