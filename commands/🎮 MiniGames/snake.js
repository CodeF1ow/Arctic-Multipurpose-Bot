...
class SnakeGame {
  constructor(options = {}) {
      ...
      if (typeof options.embed.overTitle !== 'string')  throw new TypeError('INVALID_OVER_TITLE: Sobre el Título debe ser una cadena.')

      
      if (!options.snake) options.snake = {};
      if (!options.snake.head) options.snake.head = '🟢';
      if (typeof options.snake.head !== 'string')  throw new TypeError('INVALID_EMOJI: El emoji de cabeza de serpiente debe ser una cadena.')
      if (!options.snake.body) options.snake.body = '🟩';
      if (typeof options.snake.body !== 'string')  throw new TypeError('INVALID_EMOJI: El emoji del cuerpo de la serpiente debe ser una cadena.')
      if (!options.snake.tail) options.snake.tail = '🟢';
      if (typeof options.snake.tail !== 'string')  throw new TypeError('INVALID_EMOJI: El Emoji de Cola de Serpiente debe ser una cadena.')
      if (!options.snake.over) options.snake.over = '💀';
      if (typeof options.snake.over !== 'string')  throw new TypeError('INVALID_EMOJI: El Emoji de Cola de Serpiente debe ser una cadena.')


      if (!options.emojis) options.emojis = {};
      if (!options.emojis.board) options.emojis.board = '⬛';
      if (typeof options.emojis.board !== 'string')  throw new TypeError('INVALID_EMOJI: Board Emoji debe ser una cadena.')
      if (!options.emojis.food) options.emojis.food = '🍎';
      if (typeof options.emojis.food !== 'string')  throw new TypeError('INVALID_EMOJI: El Emoji de comida debe ser una cadena.')
      

      if (!options.emojis.up) options.emojis.up = '⬆️';
      if (typeof options.emojis.up !== 'string')  throw new TypeError('INVALID_EMOJI: Up Emoji debe ser una cadena.')
      if (!options.emojis.left) options.emojis.left = '⬅️';
      if (typeof options.emojis.left !== 'string')  throw new TypeError('INVALID_EMOJI: Arriba Emoji debe ser una cadena.')
      if (!options.emojis.down) options.emojis.down = '⬇️';
      if (typeof options.emojis.down !== 'string')  throw new TypeError('INVALID_EMOJI: Arriba Emoji debe ser una cadena.')
      if (!options.emojis.right) options.emojis.right = '➡️';
      if (typeof options.emojis.right !== 'string')  throw new TypeError('INVALID_EMOJI: Arriba Emoji debe ser una cadena.')


      if (!options.foods) options.foods = [];
      if (typeof options.foods !== 'object')  throw new TypeError('INVALID_FOODS: Los Emojis de alimentos deben ser una matriz.')
      ...
      if (typeof options.stopButton !== 'string') throw new TypeError('INVALID_STOP_BUTTON: El botón de parada debe ser una cadena.')
