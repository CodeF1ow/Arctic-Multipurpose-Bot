...
module.exports = {
  ...
  description: "Cambia el Avatar del BOT: TE SUGIERO QUE LO HAGAS ASÍ: Escriba el comando en el Chat, adjunte una Imagen al Comando (no por medio de un enlace, solo agréguela) presione enter",
    ...
    try {
      ...
      if (message.attachments.size > 0) {
        if (message.attachments.every(attachIsImage)) {
          ...
          console.log('terminado de descargar!'));
